  ...
  return (
    <Section className="mt-32 px-6 py-12">
      <footer
        ...
        role="contentinfo"
        className="text-neutral-300 mb-20 text-center text-sm border-t-2 border-neutral-800 pt-16"
      >
        {/* Container */}
        <div className="max-w-[1800px] mx-auto grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Identité */}
          <div className="flex flex-col">
            <h2 className="text-3xl font-bold font-serif text-[#e3ba59]">
              Yohan Regad
            </h2>
          ...
          <nav aria-label="Footer navigation" className="flex flex-col">
            ...
            <ul className="list-none p-0 m-0 space-y-2">
              <li>
                <Link
                  href="#about"
                  className="font-serif text-[#333333] dark:text-[#f5f5dc] transition-colors hover:text-[#e3ba59] dark:hover:text-[#e3ba59] focus-visible:text-[#e3ba59] dark:focus-visible:text-[#e3ba59]"
                >
                  About Me
                </Link>
              </li>
            ...
            <ul className="list-none p-0 m-0 space-y-2">
              <li>
                <a
                  ...
                  className="font-serif transition-colors text-[#333333] dark:text-[#f5f5dc] hover:text-[#e3ba59] dark:hover:text-[#e3ba59] focus-visible:text-[#e3ba59] dark:focus-visible:text-[#e3ba59]"
                >
