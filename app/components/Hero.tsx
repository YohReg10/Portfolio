    ...
    return (
        <Section className="flex max-lg:flex-col items-start">
            <div className="flex-[2]">
                <h2 className="font-caption text-6xl font-bold" style={{ color: '#d9b96d' }}>Yohan Regad</h2>
                ...
                <p className="font-serif text-xl" style={{ color: '#d9b96d', marginBottom: '0.5rem' }}>My passions are:</p>
